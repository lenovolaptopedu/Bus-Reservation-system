...
<form method="post">
	<tr class="tabtitle">
		...
		<tr>
			...
			<td  >
				<input type="date" style="border:2; padding:2" name="journeyDate" maxlength="10" size="10"  id="journeyDate">
...
if(isset($_POST['search']))
{
	require('config.php');
	 ...
	 $query = mysql_query("select * from bus where from_stop ='$from' AND to_stop ='$to' AND date='$journeyDate'");
...
<tr align="center"><td width="115">Bus Name</td><td width="122">From</td><td width="117">To</td><td width="130">Dept Time</td><td width="130">Date</td><td width="119">Arrival Time</td><td width="110">Distance</td><td width="110">Fare</td><td>Available</td><td width="101">&nbsp;</td></tr>
<?php
...
<tr align="center"><td><?php echo $bus_name;?></td><td><?php echo $from;?></td><td><?php echo $to;?></td>
<td><?php echo $dept_time;?></td>
<td><?php echo $date;?></td><td><?php echo $arrival_time;?></td><td nowrap="nowrap"><?php echo $distance;?></td><td><?php echo $fare; ?></td><td><?php echo $c;?></td><td><a href="res.php?id=<?php echo $uid;?>&bus=<?php echo $bus;?>">Book</a>
</td></tr></table>
<?php
}
}
...
?>
     ...
     <img border="1" height="130" width="150" src="buses/14.jpg" />
     <img height="130" width="150" src="buses/1.jpg" />
     <img height="130" width="150" src="buses/2.jpg" />
     <img height="130" width="150" src="buses/3.jpg" />
     <img height="130" width="150" src="buses/4.jpg" />
     <img height="130" width="150" src="buses/5.jpg" />
     <img height="130" width="150" src="buses/6.jpg" />
     <img height="130" width="150" src="buses/7.jpg" />
     <img height="130" width="150" src="buses/8.jpg" />
     <img height="130" width="150" src="buses/9.jpg" />
     <img height="130" width="150" src="buses/10.jpg" />
     <img height="130" width="150" src="buses/11.jpg" />
     <img height="130" width="150" src="buses/12.jpg" />
     <img border="1" height="130" width="150" src="buses/13.jpg" />
